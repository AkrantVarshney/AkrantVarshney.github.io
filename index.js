function calculations() {
    ...
    //total
    document.write("<br />");
    document.write("Total amount(Basic + DA) :  ");
    ...
    if (status == "live") {
        ...
        document.write('&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;');
        document.write('&nbsp;', '&nbsp;', '&nbsp;');
        document.write("Reduced Pension : "); //reduced
        ...
        if (pensionType == "sr" || pensionType == "vr") {
            document.write("Commuted pension : "); //commuted
            ...
            document.write('&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;');
            document.write('&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;');
            document.write("Commuted Amount : ");
    ...
    document.write("Benificiary Name : ");
    ...
    document.write('&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;');
    //bank account number
    document.write("Bank Account Number : ")
    ...
    //vigilance clearance
    document.write("Vigelance Clearance : ")
